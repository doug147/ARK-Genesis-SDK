...
public:
	...
	bool                                               CallFunc_IsServer_ReturnValue;                            // 0x0B34(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_TryStruggle_success;                             // 0x0B35(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               CallFunc_Not_PreBool_ReturnValue;                         // 0x0B36(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               K2Node_CustomEvent_bEnsnare;                              // 0x0B37(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
