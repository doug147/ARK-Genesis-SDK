...
// (NetReliable, NetRequest, Event, NetResponse, Static, MulticastDelegate, Public, Protected, NetClient, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, NetRequest, Exec, Event, NetResponse, Static, MulticastDelegate, Public, Protected, NetClient, BlueprintCallable, BlueprintEvent)

void AWeapTekSniper_C::STATIC_ReceiveDestroyed()
{
