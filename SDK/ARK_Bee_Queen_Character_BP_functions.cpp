...
// (NetReliable, NetRequest, NetResponse, Public, Private, Protected, Delegate, NetServer, HasDefaults, BlueprintEvent)
// Parameters:
...
// (NetReliable, Exec, Event, NetResponse, Public, Private, Protected, Delegate, NetServer, HasDefaults, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Event, Static, Public, Private, Protected, Delegate, NetServer, HasDefaults, BlueprintEvent)
// Parameters:
