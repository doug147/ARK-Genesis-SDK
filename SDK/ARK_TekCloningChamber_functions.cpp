...
// (NetReliable, NetResponse, NetMulticast, Private, Protected, HasOutParms, HasDefaults, NetClient, BlueprintPure)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Event, NetMulticast, Public, Protected, HasOutParms, HasDefaults, NetClient, BlueprintPure)
// Parameters:
...
// (Exec, Native, Event, NetResponse, NetMulticast, Public, Protected, HasOutParms, HasDefaults, NetClient, BlueprintPure)
// Parameters:
...
// (NetReliable, Event, Static, NetMulticast, Public, Protected, HasOutParms, HasDefaults, NetClient, BlueprintPure)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
