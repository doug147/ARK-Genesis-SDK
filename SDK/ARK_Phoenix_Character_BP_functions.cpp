...
// (NetReliable, Exec, NetResponse, NetMulticast, MulticastDelegate, Public, Protected, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
// int                            AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (Exec, Static, NetMulticast, MulticastDelegate, Public, Protected, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, Exec, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Protected, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
...
// (NetRequest, Native, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Protected, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
