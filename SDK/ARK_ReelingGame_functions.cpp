...
// (Exec, Native, NetResponse, Static, NetMulticast, MulticastDelegate, Private, NetServer, HasOutParms, DLLImport, BlueprintPure)
// Parameters:
...
// (NetReliable, Exec, Native, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Private, NetServer, HasOutParms, DLLImport, BlueprintPure)
// Parameters:
...
// (NetRequest, MulticastDelegate, Public, Private, Delegate, NetServer, HasOutParms, DLLImport, BlueprintPure)
// Parameters:
// struct FGeometry*              MyGeometry                     (Parm, IsPlainOldData)
...
// (Native, MulticastDelegate, Public, Private, Delegate, NetServer, HasOutParms, DLLImport, BlueprintPure)
...
// (NetReliable, Event, MulticastDelegate, Public, Private, Delegate, NetServer, HasOutParms, DLLImport, BlueprintPure)
// Parameters:
// struct FGeometry*              MyGeometry                     (Parm, IsPlainOldData)
...
// (NetReliable, Exec, Event, MulticastDelegate, Public, Private, Delegate, NetServer, HasOutParms, DLLImport, BlueprintPure)
// Parameters:
...
// (Net, NetRequest, Native, Static, MulticastDelegate, Public, Private, Delegate, HasOutParms, DLLImport, BlueprintPure)
// Parameters:
// struct FGeometry*              MyGeometry                     (Parm, IsPlainOldData)
