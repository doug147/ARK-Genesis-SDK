...
// (NetRequest, Static, Public, Protected, NetServer, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Exec, NetMulticast, Public, Private, DLLImport, BlueprintCallable, BlueprintEvent)
...
// (Net, NetReliable, Native, NetMulticast, Public, Protected, NetServer, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, Event, NetResponse, Static, MulticastDelegate, Private, NetServer, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, Event, NetResponse, NetMulticast, MulticastDelegate, Private, NetServer, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Exec, Event, NetResponse, NetMulticast, MulticastDelegate, Private, NetServer, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// int                            AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, Native, NetResponse, Static, NetMulticast, MulticastDelegate, Private, NetServer, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, Event, Static, MulticastDelegate, Private, NetServer, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Net, NetRequest, Native, NetResponse, Static, NetMulticast, Public, Protected, NetServer, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Net, NetReliable, NetRequest, Exec, Event, NetResponse, Static, Public, Private, NetServer, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// float*                         DeltaSeconds                   (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, Exec, Event, NetResponse, MulticastDelegate, Public, NetServer, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
