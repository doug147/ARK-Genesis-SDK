...
// (NetMulticast, MulticastDelegate, Private, HasOutParms, HasDefaults, NetClient, BlueprintPure)
// Parameters:
...
// (NetRequest, Exec, Native, NetMulticast, MulticastDelegate, Private, HasOutParms, HasDefaults, NetClient, BlueprintPure)
// Parameters:
...
// (NetRequest, Exec, Static, NetMulticast, MulticastDelegate, Private, HasOutParms, HasDefaults, NetClient, BlueprintPure)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
