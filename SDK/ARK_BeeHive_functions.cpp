...
// (Net, NetReliable, NetRequest, Exec, Native, Event, NetMulticast, Public, Private, Delegate, NetServer, HasOutParms, HasDefaults, NetValidate)
// Parameters:
...
// (Net, NetReliable, Native, Static, NetMulticast, Public, Private, Delegate, NetServer, HasOutParms, HasDefaults, NetValidate)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
