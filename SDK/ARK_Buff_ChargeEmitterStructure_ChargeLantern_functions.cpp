...
// (NetRequest, Native, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Protected, Delegate, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Exec, NetResponse, Private, Delegate, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor**                 emitterActor                   (Parm, ZeroConstructor, IsPlainOldData)
...
// (Exec, Event, Static, Private, Delegate, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
