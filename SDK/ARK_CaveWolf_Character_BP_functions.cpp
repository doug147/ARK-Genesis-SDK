...
// (NetReliable, NetRequest, Exec, Event, NetResponse, NetMulticast, Public, Protected, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Native, NetResponse, Static, NetMulticast, Public, Protected, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Native, Event, NetResponse, Static, NetMulticast, Public, Protected, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct UObject_FTransform      Result                         (Parm, OutParm, IsPlainOldData)
...
// (NetResponse, Protected, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Native, NetResponse, Protected, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Exec, Event, Static, Protected, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Exec, NetResponse, NetMulticast, Protected, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, Event, NetResponse, Static, NetMulticast, Protected, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
