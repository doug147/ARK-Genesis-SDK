...
// (Native, Event, NetResponse, Static, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Exec, Event, NetResponse, NetMulticast, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Exec, Private, Protected, Delegate, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Event, NetMulticast, Private, Protected, Delegate, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, NetRequest, Exec, Event, NetResponse, Static, NetMulticast, Private, Protected, Delegate, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Exec, Native, Event, NetResponse, NetMulticast, Private, Protected, Delegate, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Native, Event, Static, NetMulticast, Private, Protected, Delegate, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, Native, Private, Delegate, HasDefaults, DLLImport)
// Parameters:
...
// (NetReliable, NetMulticast, MulticastDelegate, Private, Delegate, HasDefaults, DLLImport)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, Event, Private, Delegate, HasDefaults, DLLImport)
// Parameters:
// struct FVector                 ExplosionLoc                   (Parm, ZeroConstructor, IsPlainOldData)
// bool                           OnKaiju                        (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, Event, NetResponse, Private, Delegate, HasDefaults, DLLImport)
// Parameters:
// bool                           FirstFlock                     (Parm, ZeroConstructor, IsPlainOldData)
