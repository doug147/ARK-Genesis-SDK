...
// (NetReliable, Native, NetResponse, MulticastDelegate, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Static, MulticastDelegate, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
