...
// (NetRequest, Exec, Native, Static, NetMulticast, MulticastDelegate, Public, NetServer, NetClient, BlueprintPure)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// (MulticastDelegate, Public, Private, Protected, NetServer, NetClient, BlueprintPure)
// Parameters:
