...
// (Native, Event, NetResponse, MulticastDelegate, Public, Protected, HasOutParms, NetClient, NetValidate)
// Parameters:
...
// (Net, NetReliable, NetRequest, Native, Event, NetResponse, Static, Public, Private, Delegate, NetServer, HasOutParms, HasDefaults, NetValidate)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
