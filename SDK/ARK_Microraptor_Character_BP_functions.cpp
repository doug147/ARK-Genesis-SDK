...
// (NetRequest, Exec, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Delegate, NetServer, HasDefaults, NetValidate)
...
// (NetReliable, NetRequest, Exec, Native, NetResponse, MulticastDelegate, Public, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
// int                            AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Exec, Native, Static, MulticastDelegate, Public, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, Event, NetMulticast, MulticastDelegate, Public, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
