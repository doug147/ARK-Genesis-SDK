...
// (NetReliable, Native, Event, Static, Public, Private, Protected, Delegate, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AShooterPlayerController* ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, NetResponse, Static, Public, Private, Protected, Delegate, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Net, Exec, Event, NetMulticast, Public, Private, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Exec, Native, Event, NetResponse, Static, Public, Private, Protected, Delegate, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
