...
// (Net, NetRequest, NetResponse, NetMulticast, Public, Protected, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
...
// (Exec, Event, Static, NetMulticast, MulticastDelegate, HasDefaults, NetClient, NetValidate)
// Parameters:
...
// (Net, Event, NetResponse, NetMulticast, Public, Protected, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
// struct FText                   ReturnValue                    (Parm, OutParm, ReturnParm)
...
// (Net, NetRequest, Exec, Static, NetMulticast, Public, Protected, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
// struct FText                   ReturnValue                    (Parm, OutParm, ReturnParm)
