...
// (NetReliable, NetRequest, Exec, Native, NetResponse, Private, Protected, HasOutParms, HasDefaults, NetValidate)
// Parameters:
...
// (Net, Static, NetMulticast, MulticastDelegate, Private, Protected, HasOutParms, HasDefaults, NetValidate)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, Exec, Native, Event, Static, NetMulticast, MulticastDelegate, Private, Protected, HasOutParms, HasDefaults, NetValidate)
// Parameters:
...
// (NetMulticast, Private, Protected, HasOutParms, HasDefaults, NetValidate)
// Parameters:
