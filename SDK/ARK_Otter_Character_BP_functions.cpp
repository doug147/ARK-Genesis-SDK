...
// (NetReliable, NetRequest, Exec, NetMulticast, MulticastDelegate, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Native, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
