...
// (Exec, Event, NetResponse, NetMulticast, Private, Delegate, NetServer, NetClient, NetValidate)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Native, NetResponse, Static, NetMulticast, Private, Delegate, NetServer, NetClient, NetValidate)
// Parameters:
...
// (Native, Event, NetResponse, Static, NetMulticast, Private, Delegate, NetServer, NetClient, NetValidate)
