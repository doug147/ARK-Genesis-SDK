...
// (NetReliable, Exec, Native, NetResponse, Static, NetMulticast, Protected, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Native, Event, Protected, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
