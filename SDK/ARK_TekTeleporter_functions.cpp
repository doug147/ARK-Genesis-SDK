...
// (NetReliable, Exec, Native, Static, NetMulticast, Private, Protected, Delegate, HasOutParms, HasDefaults, NetClient, BlueprintPure)
// Parameters:
...
// (NetReliable, Exec, Native, NetResponse, Static, NetMulticast, Private, Protected, Delegate, HasOutParms, HasDefaults, NetClient, BlueprintPure)
// Parameters:
...
// (NetReliable, NetRequest, Native, Public, Protected, HasOutParms, HasDefaults, NetClient, BlueprintPure)
// Parameters:
...
// (NetReliable, Native, NetResponse, Public, Protected, HasOutParms, HasDefaults, NetClient, BlueprintPure)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
