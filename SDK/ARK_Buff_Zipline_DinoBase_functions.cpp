...
// (Exec, Native, Event, Static, MulticastDelegate, Protected, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                           _return                        (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void ABuff_Zipline_DinoBase_C::STATIC_CanZiplineFlip(bool* _return)
{
...
// (Exec, Native, Static, NetMulticast, MulticastDelegate, Protected, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, NetRequest, Exec, MulticastDelegate, Protected, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Native, NetResponse, Static, NetMulticast, MulticastDelegate, Protected, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, Static, Public, Private, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Native, NetMulticast, Public, Private, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Exec, Native, Event, NetResponse, NetMulticast, Public, Private, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
