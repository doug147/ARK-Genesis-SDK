...
// (Native, NetResponse, Static, NetMulticast, Public, Protected, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetRequest, Exec, Event, NetResponse, Static, NetMulticast, Public, Protected, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
...
// (NetReliable, NetRequest, Exec, Native, Event, NetResponse, Private, NetServer, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
