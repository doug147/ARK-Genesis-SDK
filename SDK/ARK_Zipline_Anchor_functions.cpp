...
// (NetRequest, Native, Event, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Event, NetResponse, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Native, Static, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
...
// (NetReliable, NetRequest, Exec, Event, NetMulticast, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
// Parameters:
...
// (NetRequest, Exec, Native, NetResponse, Static, NetMulticast, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
// Parameters:
...
// (NetReliable, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
