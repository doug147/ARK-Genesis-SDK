...
// (NetReliable, Exec, Native, Event, NetResponse, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Static, NetMulticast, Public, Delegate, NetServer, NetClient, BlueprintPure)
// Parameters:
...
// (NetReliable, NetRequest, Event, NetResponse, Static, NetMulticast, Public, Delegate, NetServer, NetClient, BlueprintPure)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
