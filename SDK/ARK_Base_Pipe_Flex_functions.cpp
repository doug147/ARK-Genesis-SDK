...
// (NetRequest, Exec, Native, Event, Static, NetMulticast, MulticastDelegate, Public, Private, Protected, NetServer, HasOutParms, BlueprintPure)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Native, MulticastDelegate, Public, Private, Protected, NetServer, HasOutParms, BlueprintPure)
// Parameters:
