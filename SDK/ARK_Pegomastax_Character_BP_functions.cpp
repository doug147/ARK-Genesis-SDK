...
// (Net, NetRequest, Static, MulticastDelegate, Private, HasOutParms, HasDefaults, NetValidate)
// Parameters:
...
// (NetReliable, Exec, NetMulticast, Public, Protected, HasOutParms, HasDefaults, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, Event, NetResponse, Static, NetMulticast, Public, Protected, HasOutParms, HasDefaults, NetValidate)
// Parameters:
...
// (NetReliable, Native, Event, NetResponse, Public, Protected, HasOutParms, HasDefaults, NetValidate)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, NetMulticast, Public, Protected, HasOutParms, HasDefaults, NetValidate)
// Parameters:
...
// (Exec, Native, Event, NetResponse, NetMulticast, Public, Protected, HasOutParms, HasDefaults, NetValidate)
// Parameters:
...
// (Exec, Native, Event, NetResponse, Static, NetMulticast, Public, Protected, HasOutParms, HasDefaults, NetValidate)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
