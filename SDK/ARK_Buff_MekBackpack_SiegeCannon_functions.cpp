...
// (NetRequest, Exec, Public, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
// Parameters:
...
// (NetRequest, Native, NetResponse, Public, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
// Parameters:
...
// (NetReliable, Event, Static, Public, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
...
// (Native, Event, NetResponse, Static, Public, Protected, HasOutParms, HasDefaults, NetClient, BlueprintEvent)
// Parameters:
...
// (Net, NetRequest, Exec, NetResponse, Static, Public, Private, NetServer, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// float*                         DeltaTime                      (Parm, ZeroConstructor, IsPlainOldData)
