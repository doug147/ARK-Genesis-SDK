...
// (NetRequest, Exec, Native, Static, Public, Protected, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, Event, Static, MulticastDelegate, Private, Protected, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
...
// (NetRequest, Native, NetResponse, Static, NetMulticast, MulticastDelegate, Private, Protected, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
...
// (NetReliable, Exec, Native, Event, NetResponse, Static, MulticastDelegate, Private, Protected, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
...
// (Exec, Event, NetResponse, NetMulticast, MulticastDelegate, Private, Protected, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
// class APrimalCharacter*        Target                         (Parm, ZeroConstructor, IsPlainOldData)
...
// (Exec, Native, Event, NetResponse, Protected, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
...
// (Exec, Native, Event, Static, Protected, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Event, NetResponse, NetMulticast, Protected, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetResponse, Static, NetMulticast, Protected, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
...
// (NetReliable, Exec, Native, Static, Protected, Delegate, NetServer, HasDefaults, NetValidate)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
