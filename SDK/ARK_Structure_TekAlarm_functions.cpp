...
// (NetReliable, NetRequest, Exec, Native, MulticastDelegate, Public, NetServer, HasOutParms, HasDefaults, BlueprintEvent)
...
// (NetRequest, Exec, Event, NetResponse, MulticastDelegate, Public, NetServer, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
...
// (Net, NetReliable, NetRequest, Native, Event, NetResponse, Static, Public, Protected, Delegate, NetServer, HasOutParms, BlueprintPure)
// Parameters:
// TEnumAsByte<ETekAlarmTargetTypes> Type                           (Parm, ZeroConstructor, IsPlainOldData)
...
// (Net, NetReliable, NetRequest, Native, NetMulticast, Public, Protected, Delegate, NetServer, HasOutParms, BlueprintPure)
// Parameters:
...
// (NetRequest, Event, NetResponse, Static, MulticastDelegate, Public, NetServer, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
// bool                           Result                         (Parm, OutParm, ZeroConstructor, IsPlainOldData)
...
// (NetMulticast, MulticastDelegate, Public, NetServer, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
// TEnumAsByte<ETekAlarmTargetTypes> Type                           (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, NetMulticast, MulticastDelegate, Public, NetServer, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
...
// (Exec, NetMulticast, MulticastDelegate, Public, NetServer, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Event, NetMulticast, MulticastDelegate, Public, NetServer, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
...
// (NetRequest, Exec, Static, NetMulticast, Public, Protected, Delegate, NetServer, HasOutParms, BlueprintPure)
// Parameters:
...
// (NetReliable, Native, Event, NetResponse, NetMulticast, MulticastDelegate, Public, NetServer, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
// int                            pinCode                        (Parm, ZeroConstructor, IsPlainOldData)
// bool                           Ret                            (Parm, OutParm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Native, Event, Static, Public, Private, Protected, HasOutParms, HasDefaults, BlueprintEvent)
...
// (NetReliable, Native, NetResponse, NetMulticast, Public, Private, Protected, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
...
// (NetReliable, Exec, Native, Static, NetMulticast, Public, Private, Protected, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
...
// (NetRequest, Exec, Public, Private, Protected, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Native, Event, NetResponse, Static, Public, Private, Protected, HasOutParms, HasDefaults, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
