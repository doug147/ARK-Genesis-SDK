...
// (Native, NetResponse, Static, MulticastDelegate, Protected, Delegate, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
...
// (Net, NetReliable, Exec, Native, Event, Static, NetMulticast, Public, Private, Protected, Delegate, NetServer, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
