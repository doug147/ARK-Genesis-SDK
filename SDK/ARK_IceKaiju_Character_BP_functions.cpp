...
// (NetRequest, Exec, Native, NetResponse, NetMulticast, Public, Private, NetServer, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Exec, NetResponse, Static, MulticastDelegate, Private, NetClient, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, Exec, Native, NetMulticast, MulticastDelegate, Private, NetClient, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, Native, Event, NetMulticast, MulticastDelegate, Private, NetClient, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, NetRequest, Native, NetResponse, NetMulticast, MulticastDelegate, Private, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetResponse, MulticastDelegate, Private, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<struct UObject_FTransform> InSocketTransforms             (Parm, OutParm, ZeroConstructor, ReferenceParm)
...
// (NetMulticast, MulticastDelegate, Private, NetClient, BlueprintCallable, BlueprintEvent)
...
// (NetRequest, Exec, NetResponse, NetMulticast, MulticastDelegate, Private, NetClient, BlueprintCallable, BlueprintEvent)
...
// (NetRequest, Exec, Native, Event, NetResponse, NetMulticast, MulticastDelegate, Private, NetClient, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, Native, Static, NetMulticast, MulticastDelegate, Private, NetClient, BlueprintCallable, BlueprintEvent)
...
// (Exec, Native, Event, Private, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable)
...
// (NetReliable, NetRequest, Exec, Native, Static, Private, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable)
// Parameters:
...
// (NetReliable, Exec, Native, MulticastDelegate, Protected, Delegate, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, Exec, Native, Event, NetResponse, Private, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetResponse, NetMulticast, Private, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable)
...
// (NetReliable, NetRequest, Event, Static, NetMulticast, Private, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable)
...
// (Exec, Native, Public, Private, Protected, Delegate, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
