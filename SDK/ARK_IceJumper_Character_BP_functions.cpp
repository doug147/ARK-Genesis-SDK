...
// (NetRequest, Native, NetResponse, MulticastDelegate, Private, Protected, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Net, NetReliable, Exec, Native, Event, NetResponse, MulticastDelegate, Private, Protected, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Net, NetRequest, Static, MulticastDelegate, Private, Protected, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, Event, Public, Private, Protected, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (Exec, Native, Event, NetResponse, Public, Private, Protected, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Static, Public, Private, Protected, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Exec, Native, Event, NetResponse, Static, MulticastDelegate, Private, Protected, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Exec, Native, NetMulticast, MulticastDelegate, Private, Protected, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Net, Native, Static, NetMulticast, MulticastDelegate, Private, Protected, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Exec, Native, Event, NetResponse, Static, NetMulticast, Public, Private, Protected, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Event, NetResponse, MulticastDelegate, Public, Protected, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
